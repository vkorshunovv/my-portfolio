...
export default function About() {
  return (
    ...
    >
      <article className="flex flex-wrap justify-center text-slate-200 text-xl col-start-7 col-end-12 font-medium justify-between h-3/6 text-pretty">
        <p className="my-3">
      ...
      <article className="flex justify-center content-center row-start-2 col-start-2 col-end-12 mb-12">
