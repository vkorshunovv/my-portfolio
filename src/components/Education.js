  ...
  return (
    <div id="education" className="min-h-screen bg-slate-950 ">
      ...
      <section className="flex justify-end w-11/12 items-end mt-44 ">
        <div className="animate-bounce bg-gradient-to-r from-teal-950 rounded-full p-5">
      ...
      <section className="mt-28 pb-28 grid grid-cols-12 ">
        <div className="col-start-2 col-end-6 flex  m-1">
        ...
        <div className="col-start-6 col-end-9 flex opacity-90 m-1">
        ...
        <div className="col-start-9 col-end-12 flex opacity-80 mt-1">
